...
2. Update `terraform/terraform.tfvars` with your *Project ID*, *Region*, and *Name Prefix*. The *Name Prefix* will be used as the name prefix of the provisioned resources including: GKE cluster name, GCS bucket name, Cloud SQL instance name.
