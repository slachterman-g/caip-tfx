...
8. In Visual Studio Code bring up the **Command Palette** (Shift P on MacOS) and type in Remote-Containers for a full list of commands. Choose **Attach to Running Container** and select your ssh configuration.
